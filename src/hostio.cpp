...
HostIO::HostIO() { m_quitting = false; }
...
bool HostIO::Initialize()
{
    ...
    m_display = SDL_CreateRGBSurface(
        SDL_SWSURFACE, VGA::s_video_width, VGA::s_video_height, 32, 0, 0, 0, 0);
    if (m_display == NULL)
        return false;
    ...
    r.x = 0;
    r.y = 0;
    r.h = VGA::s_video_height;
    r.w = VGA::s_video_width;
